...
SMPL_MODEL_DIR = "./to_fbx/body_models/"
GMM_MODEL_DIR = "./to_fbx/visualize/joints2smpl/smpl_models/"
SMPL_MEAN_FILE = "./to_fbx/visualize/joints2smpl/smpl_models/neutral_smpl_mean_params.h5"
# for collsion 
Part_Seg_DIR = "./to_fbx/visualize/joints2smpl/smpl_models/smplx_parts_segm.pkl"