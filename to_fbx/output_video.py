...
def process_poses(poses, gender, model_type, model_path, framework):
    ...
    if framework == "remodiffuse":
        ...
        body_pose = poses['body_pose']
        poses = body_pose
    elif framework == "motiondiffuse":
        motion_len = poses.shape[0]
        trans = np.zeros((motion_len, 3))
        poses = poses.reshape(motion_len, -1)
    ...
    image_path = "./img/checkerboard_more.png"    
...
#    bpy.data.objects['checkerboard_more'].scale = (50, 50, 50)
    ...
    bpy.data.objects['Camera'].location = (10, -10, 5)
    bpy.data.objects['Camera'].rotation_euler = (radians(70), radians(0), radians(45))
...
if __name__ == "__main__":
    ...
    # model template
    model_path = "./fbx_templates/Aj.fbx"

    # pose settings
    # poses_path = "./motiondiffuse_np_original_result/skipsinacircle_smpl_3Dparams.npz"
    # poses_path = "./mdm_np_original_result/The_person_runs_in_a_zigzag_pattern_mdm_smpl_3Dparams.npz"
    # poses_path = "./guo_np_original_result/guo_circle_smpl_3Dparams.npz"
    poses_path = "./remodiffuse_np_original_result/zigzag_remodiffuse_smpl_3Dparams.npz"
