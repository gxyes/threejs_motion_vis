...
if __name__ == "__main__":
    file_path = "./to_fbx/mdm_np_6d/sample00_rep00_smpl_params.npy"
    
    import numpy as np
    smpl = np.load(file_path, allow_pickle=True).item()
    ...
    np.savez("./to_fbx/mdm_np_angle/sample00_rep00_smpl_params", body_pose=poses_angle, transl=transl)